...
use Mgdev\VideosModule\Category\Contract\CategoryRepositoryInterface;
use Mgdev\VideosModule\Category\CategoryRepository;
...
use Mgdev\VideosModule\Video\VideoRepository;
use Anomaly\Streams\Platform\Model\Videos\VideosVideosEntryModel;
use Mgdev\VideosModule\Video\VideoModel;
...
class VideosModuleServiceProvider extends AddonServiceProvider
{
    ...
    protected $routes = [
        ...
        'admin/videos'           => 'Mgdev\VideosModule\Http\Controller\Admin\VideosController@index',
        'admin/videos/create'    => 'Mgdev\VideosModule\Http\Controller\Admin\VideosController@create',
        'admin/videos/edit/{id}' => 'Mgdev\VideosModule\Http\Controller\Admin\VideosController@edit',
    ];
    ...
    protected $middleware = [
        //Mgdev\VideosModule\Http\Middleware\ExampleMiddleware::class
    ];
     ...
     */
    protected $listeners = [
        //Mgdev\VideosModule\Event\ExampleEvent::class => [
        //    Mgdev\VideosModule\Listener\ExampleListener::class,
        //],
    ];
     ...
     */
    protected $aliases = [
        //'Example' => Mgdev\VideosModule\Example::class
    ];
